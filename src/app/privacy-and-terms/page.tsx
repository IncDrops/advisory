        ...
        <main>
          <Section title="PRIVACY POLICY">
            ...
            <SubSection title="3. Data Sharing">
              ...
              <ul className="list-disc list-inside ml-4">
                ...
                <li><strong>Google AI:</strong> Your questions are sent to Google's AI API (Gemini) for response generation (subject to Google's Privacy Policy)</li>
                <li><strong>Legal Requirements:</strong> When required by law or to protect our rights</li>
              </ul>
            </SubSection>
            <SubSection title="4. AI Processing">
              <p>Your questions are processed by third-party AI services (Google AI Gemini). While we don't store conversation history, your questions are transmitted to these services for processing. Please refer to Google's privacy policy for their data handling practices.</p>
            </SubSection>
          ...
          <Section title="TERMS OF USE">
            ...
            <SubSection title="6. AI-Generated Content">
                <p>All responses are generated by artificial intelligence (Google AI Gemini). The AI:</p>
                <ul className="list-disc list-inside ml-4">
            ...
            <SubSection title="16. Third-Party Services">
                ...
                <ul className="list-disc list-inside ml-4">
                    ...
                    <li><strong>Google AI</strong> for AI processing (subject to Google's Terms)</li>
                    <li><strong>Firebase App Hosting</strong> for hosting (subject to Google's and Firebase's Terms)</li>
                </ul>
